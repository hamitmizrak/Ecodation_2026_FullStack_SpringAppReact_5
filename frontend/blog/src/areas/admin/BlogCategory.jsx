        ...
        <>
            <div className="container py-4">
                ...
                {showView && selected && (
                    ...
                    >
                        {/*
              2. Meet Tipini Seç ister Kurs Seçerek ister Hemen Meet tıkladığımda
             modal olarak hangi butona tıkladıysam şimdi verdiğim eski_CourseMeetContent.js gerekli inputların gelmesini istiyorum her bir input doldurdukça diğer input gelmeli, bitirme yüzdesi olması gerekiyor ve her bir input doldurduğumda başarı rozeti olsun bakarak yeniden yazmanı istiyorum CourseMeetContent.js
              */}
                        <div className="modal-dialog" onClick={(e) => e.stopPropagation()}>
                            <div className="modal-content">
                                <div className="modal-header">
